...
6. Solve a constrained residual problem.
...
7. Apply stabilization only where needed.
...
11. Serialize the accepted state.
...
The initializer can be posed as a constrained residual minimization problem:
...
A bounded least-squares solver is the most practical starting point because:
