...
| `UR-015`..`UR-017`, `FR-007c`, `FR-009d`..`FR-009g`, `FR-019a`..`FR-019o`, `FR-025a`, `FR-026a`, `FR-026b`, `FR-037`, `FR-037a` | `docs/dynamic_model_current_state_2026-07-12.md`, `docs/dd_060_physics_owned_tray_flow_probe_20260712.md`, `docs/dd_065_frozen_checkpoint_uv_hydraulic_closure_20260717.md`, `docs/dd_066_terminal_conserved_inventory_mapping_20260717.md`, `docs/dd_067_conservative_energy_redistribution_probe_20260717.md`, `docs/dd_068_least_movement_redistribution_20260717.md`, `docs/dd_069_terminal_energy_volume_basis_audit_20260717.md`, `docs/dd_070_canonical_checkpoint_repair_20260717.md`, `docs/dd_071_direct_steady_state_registry_20260718.md`, `docs/dd_072_direct_steady_state_numerical_audit_20260718.md`, `docs/gates_explained.md`, `src/dynamic_distillation/direct_steady_state_registry_v1.py`, `src/dynamic_distillation/direct_steady_state_residual_v1.py`, `tools/audit_direct_steady_state_registry.py`, `tools/audit_direct_steady_state_numerics.py` | `tests/test_direct_steady_state_registry_v1.py`, `tests/test_direct_steady_state_residual_v1.py`; DD-071 selects a square, structurally full-rank combined bottom control volume. DD-072 passes direct residual finiteness, conservation telescoping, sparsity verification, and full numerical rank at two ChemSep-related guesses and two step sizes. Bounded continuation remains pending; no accepted steady-state initializer exists yet. |
...
- Open architecture requirements `FR-019a` through `FR-019o`, `FR-037`, and `FR-037a` were identified and refined by DD-060 through DD-072. DD-070 retires checkpoint repair after its bounded corrected retry. DD-071 provides a square, structurally full-rank direct registry using a combined conserved bottom control volume. DD-072 passes direct live residual, telescoping, sparsity, and numerical-rank gates, while exposing high conditioning and large unsolved hydraulic residuals. Bounded continuation, multi-start robustness, and dynamic acceptance remain pending. These are solver-readiness results, not a passing production initializer.
