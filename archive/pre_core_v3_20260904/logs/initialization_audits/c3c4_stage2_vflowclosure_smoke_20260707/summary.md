...
- Excel: `C:\Users\Thomas Zvolensky\Documents\Python Scripts\Dynamic_DistillationII\logs\c3c4_initializer_residual_stage2_vflowclosure_smoke_20260707.xlsx`
- Thermo: `clapeyron`
...
- Pass: `False`
- Worst relative state rate: `0.014175899 1/s`
- Worst absolute state rate: `2891.6814 per s`
- Max tray total material residual: `594.22336 lbmol/h`
...
|---|---:|---:|---:|---|
| `tray_EV_BTU` | 0.014175899 | 1174.3683 | 2 |  |
| `tray_EL_BTU` | 0.012741028 | 2891.6814 | 2 |  |
| `tray_V` | 0.0095541834 | 0.21901101 | 19 | n-Butane |
| `tray_L` | 0.007046057 | 0.060384183 | 12 | n-Pentane |
| `bottom_L` | 0.0038121038 | 0.14657509 | 21 | n-Propane |
| `tray_T_f` | 0.0037239134 | 0.46166185 | 2 |  |
| `top_L` | 0.00067466407 | 0.44733174 | 0 | n-Butane |
...
|---:|---|---:|---|---:|---:|---:|
| 1 | `tray_EV_BTU` | 2 |  | 1174.3683 | 0.014175899 | 82841.594 |
...
| 18 | `tray_V` | 2 | n-Propane | -0.21901101 | 0.0060829039 | 35.004351 |
