...
- Excel: `C:\Users\Thomas Zvolensky\Documents\Python Scripts\Dynamic_DistillationII\logs\initializer_orchestrator_end_to_end_smoke2_20260708\coupled-vle-topL.xlsx`
- Thermo: `table`
...
- Pass: `False`
- Worst relative state rate: `0.053786702 1/s`
...
- Total condenser boundary energy residual relative scale: `-7.584718e-17`
...
|---|---:|---:|---:|---|
| `tray_V` | 0.053786702 | 0.30982808 | 3 | n-Butane |
...
|---:|---|---:|---|---:|---:|---:|
| 1 | `tray_V` | 3 | n-Butane | 0.17967947 | 0.053786702 | 2.3405927 |
...
| 7 | `tray_V` | 3 | n-Propane | -0.19308995 | 0.018361998 | 9.5157375 |
