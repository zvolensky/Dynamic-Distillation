...
def compact_stage_table(
    ...
    *,
    ...
    cols = [
        ...
        "Flooding_fraction",
        "Flooding_classification",
        "Vapor_superficial_velocity_ft_s",
        "Vapor_F_factor",
        "Liquid_to_vapor_mass_flow_parameter",
        "Critical_effective_capacity_factor_ft_s",
        "Backup_fraction_of_tray_spacing",
        "Backup_classification",
        "Weeping_classification",
        "Hydraulic_limitation",
        "Hydraulic_vapor_flow_ratio_to_baseline",
        "Hydraulic_liquid_flow_ratio_to_baseline",
        "Hydraulic_vapor_superficial_velocity_ratio_to_baseline",
        "Hydraulic_vapor_f_factor_ratio_to_baseline",
        "Hydraulic_total_tray_pressure_drop_ratio_to_baseline",
        "Hydraulic_backup_fraction_ratio_to_baseline",
        "Hydraulic_critical_effective_capacity_factor_ratio_to_baseline",
    ]
