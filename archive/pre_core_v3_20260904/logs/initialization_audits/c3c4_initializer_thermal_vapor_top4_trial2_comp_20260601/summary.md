...
- Excel: `C:\Users\Thoma\Documents\Python Scripts\Dynamic_DistillationII\logs\c3c4_initializer_thermal_vapor_top4_trial2_comp_20260601.xlsx`
- Thermo: `clapeyron`
...
- Pass: `False`
- Worst relative state rate: `0.033318721 1/s`
- Worst absolute state rate: `4026.9606 per s`
- Max tray total material residual: `3585.0208 lbmol/h`
...
|---|---:|---:|---:|---|
| `tray_V` | 0.033318721 | 0.71319716 | 2 | n-Propane |
| `tray_T_f` | 0.020272726 | 2.5891515 | 2 |  |
| `tray_EL_BTU` | 0.01580186 | 4026.9606 | 5 |  |
| `tray_L` | 0.01255204 | 0.20464479 | 3 | n-Butane |
| `bottom_L` | 0.0033155561 | 0.12748287 | 21 | n-Propane |
| `top_L` | 0.0029926965 | 0.67105185 | 0 | n-Butane |
...
|---:|---|---:|---|---:|---:|---:|
| 1 | `tray_V` | 2 | n-Propane | 0.71319716 | 0.033318721 | 20.405298 |
...
| 6 | `tray_V` | 16 | n-Propane | -0.34489407 | 0.026022554 | 12.253659 |
| 7 | `tray_V` | 2 | n-Butane | 0.28950502 | 0.025968071 | 10.148499 |
...
| 19 | `tray_T_f` | 2 |  | -2.5891515 | 0.020272726 | 126.716 |
| 20 | `tray_V` | 3 | n-Propane | 0.37066646 | 0.018417542 | 19.12573 |
