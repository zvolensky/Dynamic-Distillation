...
- Result: `bottom_level_control_hold_passed`
- Controller: `Kc=24.0, Ti=365.0 s`
- Bottoms bias: `1.0` through `0.0 s`; removed: `True`
- Bottoms: `7936.640000` to `7936.640000 lbmol/h`
- Bottom level: `51.746555%` to `51.746555%`
- Clock/sim ratio: `87.372627`
