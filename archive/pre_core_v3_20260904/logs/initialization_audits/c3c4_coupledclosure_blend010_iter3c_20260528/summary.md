...
- Excel: `C:\Users\Thoma\Documents\Python Scripts\Dynamic_DistillationII\logs\c3c4_splitter_openloop_seed_coupledclosure_blend010_iter3c_20260528.xlsx`
- Thermo: `clapeyron`
- Runtime mode: `parity`
- Pressure model: `spec`
...
- Pass: `False`
- Worst relative state rate: `0.028363849 1/s`
- Worst absolute state rate: `0.20382794 per s`
...
|---|---:|---:|---:|---|
| `tray_L` | 0.028363849 | 0.20382794 | 2 | n-Pentane |
| `tray_V` | 0.018405532 | 0.19479454 | 19 | n-Pentane |
| `bottom_L` | 0.00046662394 | 0.05062233 | 21 | n-Pentane |
| `top_L` | 6.6104107e-11 | 1.4543971e-08 | 0 | n-Pentane |
...
|---:|---|---:|---|---:|---:|---:|
| 1 | `tray_L` | 2 | n-Pentane | 0.028390866 | 0.028363849 | 0.00095249227 |
| 2 | `tray_V` | 19 | n-Pentane | 0.067622509 | 0.018405532 | 2.6740318 |
| 3 | `tray_V` | 2 | n-Butane | 0.11939699 | 0.014877238 | 7.025481 |
| 4 | `tray_V` | 3 | n-Butane | 0.13256495 | 0.014665184 | 8.0394329 |
| 5 | `tray_V` | 11 | n-Pentane | 0.024097373 | 0.013847129 | 0.7402433 |
| 6 | `tray_L` | 3 | n-Butane | -0.14102024 | 0.013108421 | 9.7579886 |
| 7 | `tray_V` | 18 | n-Propane | -0.1031181 | 0.012241618 | 7.4235675 |
| 8 | `tray_V` | 19 | n-Propane | 0.079427438 | 0.012094132 | 5.5674361 |
| 9 | `tray_L` | 2 | n-Butane | 0.093157488 | 0.011714232 | 6.9525048 |
